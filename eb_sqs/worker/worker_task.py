...
class WorkerTask(object):
    ...
    def serialize(self):
        ...
        kwargs = (
            WorkerTask._pickle_args(self.kwargs) if self.use_pickle else self.kwargs
        )
    ...
    def _pickle_args(args):
        return base64.b64encode(pickle.dumps(args, pickle.HIGHEST_PROTOCOL)).decode(
            "utf-8"
        )
    ...
    def deserialize(msg: str) -> "WorkerTask":
        ...
        kwargs = (
            WorkerTask._unpickle_args(task["kwargs"]) if use_pickle else task["kwargs"]
        )
